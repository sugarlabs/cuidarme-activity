...
class PangoFont(object):
    ...
    def doPaint(self, text, antialias=True, color=(255,255,255), background=None ):
        ...
        """
        log.info( 'doPaint: %r, antialias = %s, color=%s, background=%s', text, antialias, color, background )
